<template>
 <div class="font-sans max-w-5xl max-md:max-w-xl mx-auto bg-white py-4 mt-40">
            ...
            <div class="grid md:grid-cols-3 gap-8 mt-16">
                <div class="md:col-span-2 space-y-4">
                    <div class="grid grid-cols-3 items-start gap-4">
                        <div class="col-span-2 flex items-start gap-4">
                            <div class="w-28 h-28 max-sm:w-24 max-sm:h-24 shrink-0 bg-gray-100 p-2 rounded-md">
                                <img src='/images/plate-1.png' class="w-full h-full object-contain" />
                            </div>

                            <div class="flex flex-col">
                                <h3 class="text-base font-bold text-gray-800">Stuffed Red Pumpkin</h3>
                        ...
                        <div class="ml-auto">
                            <h4 class="text-lg max-sm:text-base font-bold text-gray-800">$5.00</h4>
                    ...
                    <div class="grid grid-cols-3 items-start gap-4">
                        <div class="col-span-2 flex items-start gap-4">
                            <div class="w-28 h-28 max-sm:w-24 max-sm:h-24 shrink-0 bg-gray-100 p-2 rounded-md">
                                <img src='/images/plate-2.png' class="w-full h-full object-contain" />
                            </div>

                            <div class="flex flex-col">
                                <h3 class="text-base font-bold text-gray-800">Greek Salad</h3>
                        ...
                        <div class="ml-auto">
                            <h4 class="text-lg max-sm:text-base font-bold text-gray-800">$9.00</h4>
                    ...
                    <div class="grid grid-cols-3 items-start gap-4">
                        <div class="col-span-2 flex items-start gap-4">
                            <div class="w-28 h-28 max-sm:w-24 max-sm:h-24 shrink-0 bg-gray-100 p-2 rounded-md">
                                <img src='/images/plate-3.png' class="w-full h-full object-contain" />
                            </div>

                            <div class="flex flex-col">
                                <h3 class="text-base font-bold text-gray-800">Russian Salad</h3>
                        ...
                        <div class="ml-auto">
                            <h4 class="text-lg max-sm:text-base font-bold text-gray-800">$6.00</h4>
                ...
                <div class="bg-gray-100 rounded-md p-4 h-max">
                    ...
                    <ul class="text-gray-800 mt-6 space-y-3">
                        <li class="flex flex-wrap gap-4 text-sm">Subtotal <span class="ml-auto font-bold">$25.00</span></li>
                        ...
                        <hr class="border-gray-300" />
                        <li class="flex flex-wrap gap-4 text-sm font-bold">Total <span class="ml-auto">$31.00</span></li>
                    </ul>
