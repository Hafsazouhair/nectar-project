<template>
<footer class="bg-gray-800 py-8 px-8 font-[sans-serif] tracking-wide mt-40">
      <div class="relative">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8 pt-10">
          <div>
            ...
            <p class="text-gray-400 text-base">We cook the best tasty food.
We prepare the best food in the entire city, with excellent customer service, the best meals, and at the best prices. Come visit us!</p>
          </div>

          <div>
            <h4 class="text-xl font-semibold mb-6 text-white">Services</h4>
            <ul class="space-y-4">
              <li><a href="javascript:void(0)" class="text-gray-400 hover:text-gray-300 text-base">Reservation Management
                </a></li>
              <li><a href="javascript:void(0)" class="text-gray-400 hover:text-gray-300 text-base">Customer Reviews
                </a></li>
              <li><a href="javascript:void(0)" class="text-gray-400 hover:text-gray-300 text-base">Staff Management
                </a></li>
              <li><a href="javascript:void(0)" class="text-gray-400 hover:text-gray-300 text-base">Analytics & Reporting
                </a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul class="space-y-4">
              ...
              <li class="text-gray-400 text-base">Morocco</li>
              <li class="text-gray-400 text-base"> support@nectar.com</li>
              <li class="text-gray-400 text-base">+212*********</li>
            </ul>
          </div>
      ...
      <div class="bg-gray-900 py-4 px-4 -mx-8 text-center mt-10">
        <p class='text-gray-400 text-base'>© Nectar. All rights reserved.</p>
      </div>
    </footer>
